...
public class MainEngine
{
    ...
    public void updateBranchCommit(String SHA1) throws IOException
    {
    ...
    public String makeCommit(String rootSHA1,String prevCommit,String secondePrevCommit ,String dateCreated, String username, String msg , String dateModify)
    {
    ...
    public FolderSHA1Info createObjects(String path) throws IOException
    {
    ...
    private void createBranchWithSHA1(String branchName, String SHA1) throws IOException
    {
    ...
    private void updateHead(String branchHead) throws IOException
    {
...
//            f2.delete();
    ...
    public Boolean createBranch(MagitSingleBranch branch,String head) throws IOException
    {
        String type = "";
...
//        repositoryManager.refreshObj();
        ...
        String fatherSHA1 = new String(Files.readAllBytes(Paths.get(pathFrom + "\\.magit\\branches\\" + activeBranch)));
...
//    }
    ...
    public void createAllObjcets() throws IOException, FirstCommitException
    {
        ...
        for(String branch : Branches)
        {
            ...
            MainEngine.repositoryManager.refreshObj();
        }
        MainEngine.repositoryManager.switchHeadBranch(headBranch);
    }
